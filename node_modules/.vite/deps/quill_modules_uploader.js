...
Uploader.DEFAULTS = {
  ...
  handler(range, files) {
    ...
    Promise.all(promises).then((images) => {
      ...
      }, new import_quill_delta.default().retain(range.index).delete(range.length));
...
export {
  uploader_default as default
};
//# sourceMappingURL=quill_modules_uploader.js.map
